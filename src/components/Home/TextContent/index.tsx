    ...
    return (
        <div className='w-full md:w-[60%] xl:w-fit h-fit md:h-[20rem] xl:h-full xl:py-8 flex flex-col gap-6 xs:gap-8 justify-between'>
            <div className="flex flex-col gap-2 xs:gap-4">
                <h1 className="text-7xl xl:text-8xl font-bold text-transparent text-gradient">
                    Frontend <br /> Developer
                </h1>
                <p className='text-2xl xl:text-3xl font-semibold text-gradient'>
                    3 years of experience
                </p>
            </div>

            <div className="flex flex-col xl:gap-2">
                <p className="text-xs xs:text-sm xl:text-base text-gradient tracking-wide">companies and community i have worked with</p>
