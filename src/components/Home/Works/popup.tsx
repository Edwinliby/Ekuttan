    ...
    return (
        ...
        >
            <motion.div
                ...
                className='relative bg-gradient-to-br from-[var(--bg-start)] to-[var(--bg-end)] w-full md:w-[80%] h-[90%] md:h-[85%] pt-6 px-4 md:px-6 rounded-2xl border border-white/20 shadow-2xl flex flex-col'
            >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 pb-8 ">
                        {items.map((item, i) => (
                            <motion.div
                                ...
                                key={i}
                                className="group relative rounded-xl overflow-hidden shadow-md hover:shadow-xl border border-gray-500/20 transition-all duration-300 bg-white/5"
                            >
